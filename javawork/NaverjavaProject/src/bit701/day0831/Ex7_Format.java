...
public class Ex7_Format {
	...
	public static void main(String[] args) {
		...
		//패턴2
		SimpleDateFormat dateFormat2=new SimpleDateFormat("yyyy년MM월dd일 a hh:mm:ss EEEE");//a:오전/오후 EEEE:요일길게 hh:12시간 기준
		...
		NumberFormat numberFormat2=NumberFormat.getInstance();//지역설정된 화폐단위 붙여서 출력
	    System.out.println(numberFormat2.format(money));	

		double num=456.12345;
		System.out.println(numberFormat.format(num));//456.123

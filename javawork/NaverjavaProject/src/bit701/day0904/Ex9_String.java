...
public class Ex9_String {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.indexOf('a'));//str1 에서 첫번째 'a'의 인덱스 값
		...
		System.out.println(str3.startsWith("Have"));//str3 가 Have로 시작하면 true
		System.out.println(str3.endsWith("day"));//str3 가 day로 끝나면 true
		System.out.println(str1.equals(str2));//str1 이 str2 와 대소문자까지 완벽하게 같을경우 true
		System.out.println(str1.equalsIgnoreCase(str2));//대소문자 상관없이 철자만 같으면 true
		System.out.println(str1.compareTo(str2));//str1 과 str2 의 차이(양수값이:str1이 더 큰값,음수값:str2가 더 큰 경우)
